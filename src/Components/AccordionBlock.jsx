    ...
    return (
        <div className="accordion-block mb-6 last:mb-0">
            <div className="accordion-single">
                ...
                {/* {show ?  */}
                    <div ref={contentEl} className="accordion-content mt-2 py-0 px-4 bg-white rounded-lg transition-all duration-500 ease-in-out overflow-hidden" style={show ? {height: contentEl.current.scrollHeight} : {height:"0px", overflow:"hidden"}}>
